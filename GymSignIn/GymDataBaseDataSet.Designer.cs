...
namespace GymSignIn {
    ...
    public partial class GymDataBaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int Id, string Time, string Name, string Phone) {
...
namespace GymSignIn.GymDataBaseDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Time = 1 AND [Time] IS NULL) OR ([Time] = @Original_Time)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Time], [Name], [Phone]) VALUES (@Id, @Time, @Na" +
                "me, @Phone);\r\nSELECT Id, Time, Name, Phone FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Time] = @Time, [Name] = @Name, [Phone] = @Phone WHERE (([Id] = @Original_Id) AND ((@IsNull_Time = 1 AND [Time] IS NULL) OR ([Time] = @Original_Time)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT Id, Time, Name, Phone FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Time, Name, Phone FROM dbo.[Table]";
        ...
        public virtual int Fill(GymDataBaseDataSet.TableDataTable dataTable) {
        ...
        public virtual GymDataBaseDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            GymDataBaseDataSet.TableDataTable dataTable = new GymDataBaseDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GymDataBaseDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Time, string Original_Name, string Original_Phone) {
        ...
        public virtual int Insert(int Id, string Time, string Name, string Phone) {
        ...
        public virtual int Update(int Id, string Time, string Name, string Phone, int Original_Id, string Original_Time, string Original_Name, string Original_Phone) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Time, string Name, string Phone, int Original_Id, string Original_Time, string Original_Name, string Original_Phone) {
            return this.Update(Original_Id, Time, Name, Phone, Original_Id, Original_Time, Original_Name, Original_Phone);
        }
    }
